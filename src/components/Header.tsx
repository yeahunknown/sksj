        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="glass border-white/20 px-4 py-2 rounded-lg text-white hover:bg-white/10 transition-all duration-300 text-sm font-medium flex items-center gap-2"
            >
