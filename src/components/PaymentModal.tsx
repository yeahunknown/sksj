...
const PaymentModal = ({ isOpen, onClose, onSuccess, amount, type }: PaymentModalProps) => {
  ...
  return (
    ...
    >
      <div className="bg-gray-900 border border-green-600/30 rounded-2xl p-8 max-w-md w-full shadow-2xl">
        {/* PGPAY Header */}
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2 mt-1">
              <div className="flex-1 bg-gray-800 px-3 py-2 rounded-lg text-sm font-mono break-all text-green-400">
                {recipientAddress}
              </div>
              <Button
                variant="outline"
                ...
                className="bg-gray-800 border-gray-700 hover:bg-gray-700 shrink-0"
              >
                Copy
              </Button>
            </div>
