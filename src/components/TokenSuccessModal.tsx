        ...
        <div className="space-y-6">
          <div className="glass rounded-xl p-4 border border-white/20">
            ...
            <div className="flex items-center space-x-2">
              <code className="flex-1 bg-gray-800 px-3 py-2 rounded-lg text-sm font-mono text-green-400 border border-gray-600 min-w-0 overflow-hidden">
          ...
          <div className="flex space-x-4">
            ...
            <Button
              ...
              variant="outline"
              className="flex-1 glass border-white/20 hover:bg-white/10 text-white font-medium py-3"
            >
              View Portfolio
            </Button>
          </div>
